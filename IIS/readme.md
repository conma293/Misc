This script can be uploaded to an IIS server and then used to output machinekeys; similar to webshell or stealing azure access tokens --> https://gist.github.com/irsdl/36e78f62b98f879ba36f72ce4fda73ab
